...
with open(r"facerecognition_admin.csv",'r') as new_file:
        ...
        if True:
            ...
            for face_encoding in face_encodings:
                ...
                if name not in v and name != "Unknown": 
                    ...
                    myData = [xa,img_name]
                    with open("facerecognition_admin.csv",'a') as csv_file:
...
def conversation(user_name):
    ...
    while (flag!=1):
        ...
        if "hello" in  word or "hi jarvis" in word or "hey jarvis" in word:
            ...
            for d in GoogleSearch().search(word2, tld="co.in", num=10, stop=10, pause=2):
                print(d)
                txt_to_speech(d)
